let check_menu = true;
const theme_menu = document.querySelectorAll(".drop-js");
const link_outline = document.querySelectorAll(".out-js");
const theme_select = document.querySelector(".theme-select").style;
const search_input = document.querySelector("#inp-search");
